...
export function toPublic(t: Technique): TechniquePublic {
  return {
    ...
    youtubeShortUrl: t.youtubeShortUrl,
    youtubeShortStartSeconds: t.youtubeShortStartSeconds,
    youtubeShortEndSeconds: t.youtubeShortEndSeconds,
...
export async function upsertTechnique(
  ...
  const created: Technique = {
    ...
    youtubeEndSeconds: input.youtubeEndSeconds,
    youtubeShortUrl: input.youtubeShortUrl || "",
    youtubeShortStartSeconds: input.youtubeShortStartSeconds,
    youtubeShortEndSeconds: input.youtubeShortEndSeconds,
